...
module.exports = {
  ...
  execute(client, message, args) {
    ...
    if (Number.isNaN(number)) return message.reply('<:unchecked:860839603098877953> • Nombre spécifié invalide.');
    
    const result = client.getRandomIntInclusive(1, number);
    message.reply('<a:roll_dice:866781176371085403> • Le dé roule...').then(msg => {
