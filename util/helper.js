...
module.exports = {
  ...
  hateMessages: {
    "<:hug:865179346222055424> • Il n'y a pas meilleur(e)s ami(e)s que vous, c'est certain !":
      [0],
    '🥂 • Aucun problème entre vous !': [1, 2, 3, 4, 5],
    '☀️ • Vous vous entendez très bien.': [6, 7, 8, 9, 10],
    '😁 • Pas de raisons de vous inquiéter : vous êtes bons amis.': [
      11, 12, 13, 14, 15,
    ],
    "😄 • Quelques petites tensions. Mais c'est tout à fait normal !": [
      16, 17, 18, 19, 20,
    ],
    "😋 • Vous n'êtes pas toujours d'accord, mais bon : vos disputes se font rares.":
      [21, 22, 23, 24, 25],
    '🤷‍♂️ • Vous avez de petits différends, parfois.': [26, 27, 28, 29, 30],
    '😓 • Vous ne vous entendez pas sur tous les points...': [
      31, 32, 33, 34, 35,
    ],
    ...
    '🌶 • Presque à la moyenne ? Vos relations sont pimentées...': [
      46, 47, 48, 49,
    ],
    '😕 • Pile à la moyenne : pas terrible...': [50],
    "😑 • C'est un peu plus de la moyenne : vous vous agacez plutôt souvent.": [
      51, 52, 53, 54, 55,
    ],
    "👀 • Hé, calmez-vous ! N'en venez pas aux poings !": [56, 57, 58, 59, 60],
    "⚡️ • Eh bien ! vous n'avez pas l'air de vous apprécier...": [
      61, 62, 63, 64, 65,
    ],
    '👁️ • Il y a de la haine dans vos yeux.': [66, 67, 68, 69, 70],
    '🙏 • Ouhlala. Retenez-les !': [71, 72, 73, 74, 75, 76, 77, 78, 79, 80],
    '🤬 • Vous ne manquez pas une occasion de vous injurier copieusement.': [
      81, 82, 83, 84, 85, 86, 87, 88, 89, 90,
    ],
    '🔥 • Vous vous haïssez au plus haut point et ne pouvez pas vous voir en peinture.':
      ...
      replaced.forEach((val) => {
        if (typeof val[1] === 'string') {
          val[1] = val[1]
            ...
            .replace('{server.id}', guild.id)
            .replace(/{server.membercount}/gi, guild.memberCount)
            .replace(
              /{server.created}/gi,
              moment(guild.createdAt).format('DD/MM/YYYY')
            );
        }
      });
  ...
  shipMessages: {
    ...
    "💔 • Pas besoin d'être devin pour déduire que c'est très peu probable...":
      [1, 2, 3, 4, 5],
    ...
    '⛅ • Ça pourrait bien marcher...! Encore faut-il oser !': [
      31, 32, 33, 34, 35,
    ],
    '🔮 • Une relation est peut-être possible...!': [36, 37, 38, 39, 40],
    "🎵 • Ce n'est pas un score à négliger !": [41, 42, 43, 44, 45],
    '🌀 • Vous êtes presque à la moyenne ! Courage, il y a des chances !': [
      46, 47, 48, 49,
    ],
    '🎋 • Pile à la moyenne ! On peut tenter le coup...!': [50],
    "🎴 • C'est un peu plus de la moyenne, pas trop mal !": [
      51, 52, 53, 54, 55,
    ],
    "🎯 • Il y a une possibilité ! Le tout, c'est d'y aller !": [
      56, 57, 58, 59, 60,
    ],
    "🔥 • C'est vraiment pas mal !": [61, 62, 63, 64, 65],
    '🌟 • Le score est très bon ! Tu as toutes tes chances, crois-moi.': [
      66, 67, 68, 69, 70,
    ],
    "❤ • Il y a un bel amour dans l'air !": [
      71, 72, 73, 74, 75, 76, 77, 78, 79, 80,
    ],
    "💝 • Vous êtes faits l'un pour l'autre, aucun doute !": [
      81, 82, 83, 84, 85, 86, 87, 88, 89, 90,
    ],
    "💖 • Cet amour brille de mille feux ! C'est un couple magnifique.": [
      91, 92, 93, 94, 95, 96, 97, 98, 99,
    ],
    '💘✨ Score maximal ! ✨💘': [100],
  },
  ...
  toEmbed(string) {
    ...
    const embed = new MessageEmbed().setTitle(args[0]).setDescription(args[1]);
